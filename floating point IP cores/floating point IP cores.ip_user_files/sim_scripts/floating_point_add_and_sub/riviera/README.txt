...
#
# Generated by export_simulation on Tue Apr 08 14:52:33 +0100 2025
#
################################################################################
...
'-reset_run' switch to the './floating_point_add_and_sub.sh' script.

./floating_point_add_and_sub.sh -reset_run
...
./floating_point_add_and_sub.sh -noclean_files

For more information on the script, please type './floating_point_add_and_sub.sh -help'.
